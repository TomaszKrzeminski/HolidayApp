namespace HolidayApp.Migrations
{
    ...
    public partial class First : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "Hotel_HotelId", "dbo.Hotels");
            ...
            DropForeignKey("dbo.Comments", "Resort_ResortId", "dbo.Resorts");
            ...
            DropIndex("dbo.Comments", new[] { "Hotel_HotelId" });
            DropIndex("dbo.Comments", new[] { "Resort_ResortId" });
